  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: "Welcome back to your GreenNova investor dashboard!",
      });
      ...
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1">
          ...
          <div className="flex justify-center mb-2">
            <User className="h-12 w-12 text-greennova-purple" />
          </div>
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button type="submit" className="w-full bg-greennova-purple" disabled={isLoading}>
              {isLoading ? (
                <>
          ...
          <div className="mt-4 text-center">
            <Link to="/login/project-owner" className="text-sm text-greennova-purple hover:underline">
